package de.telekom.llcto.ecn_bits.jdk.client;
...
import de.telekom.llcto.ecn_bits.jdk.lib.Bits;
...
public final class Main {
    ...
    private static RuntimeException usage(final String err) {
        ...
        System.err.println("Usage: java -jar target/client-*-cli.jar hostname port [tc]");
        System.exit(1);
    ...
    private static IPorFQDN parseHostname(final String s) {
        ...
        if (i6 != null) {
            return new IPorFQDN(s, i6);
        }
        final InetAddress i4 = IPAddress.v4(s);
        if (i4 != null) {
            return new IPorFQDN(s, i4);
        }
    ...
    public static void main(String[] argv) {
        ...
        if (argv.length == 3) {
            if ("NO".equals(argv[2])) {
                ...
                try {
                    final Integer v = Integer.decode(argv[2]);
                    if (v == null || v < 0 || v > 255) {
        ...
        System.out.printf("connect to [%s]:%d with %s%n", hostname.resolved ?
