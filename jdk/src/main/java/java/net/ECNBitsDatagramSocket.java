...
public class ECNBitsDatagramSocket extends DatagramSocket {
    /*static {
        try {
            ...
            System.err.println("ECN-Bits: unable to setDatagramSocketImplFactory: " + e);
        }
    }*/
    ...
    public Byte retrieveLastTrafficClass() {
        return eimpl == null ? null : eimpl.retrieveLastTrafficClass();
    }
    ...
    public ECNStatistics getMeasurement(final boolean doContinue) {
        return eimpl == null ? null : eimpl.doMeasuring(doContinue);
    }
}
